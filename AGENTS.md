...
- Official DeepSeek contract calls disable its default thinking mode so the bounded output budget produces final validated JSON; custom endpoints receive no DeepSeek-specific parameters (D49).
